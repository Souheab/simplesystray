...
#ifndef __DBUS_STATUS_NOTIFIER_WATCHER_H__
#define __DBUS_STATUS_NOTIFIER_WATCHER_H__
...
struct _SnWatcherIface
{
  ...
  gboolean  (*get_is_host_registered) (SnWatcher *object);

  gint  (*get_protocol_version) (SnWatcher *object);

  const gchar *const * (*get_registered_items) (SnWatcher *object);
...
void sn_watcher_complete_register_item (
    SnWatcher *object,
    GDBusMethodInvocation *invocation);

void sn_watcher_complete_register_host (
    SnWatcher *object,
    GDBusMethodInvocation *invocation);
...
void sn_watcher_emit_item_registered (
    SnWatcher *object,
    const gchar *arg_service);

void sn_watcher_emit_item_unregistered (
    SnWatcher *object,
    const gchar *arg_service);

void sn_watcher_emit_host_registered (
    SnWatcher *object);



/* D-Bus method calls: */
void sn_watcher_call_register_item (
    SnWatcher *proxy,
    const gchar *arg_service,
...
gboolean sn_watcher_call_register_item_finish (
    SnWatcher *proxy,
    GAsyncResult *res,
    GError **error);

gboolean sn_watcher_call_register_item_sync (
    SnWatcher *proxy,
    const gchar *arg_service,
    GCancellable *cancellable,
    GError **error);

void sn_watcher_call_register_host (
    SnWatcher *proxy,
    const gchar *arg_service,
    GCancellable *cancellable,
    GAsyncReadyCallback callback,
...
gboolean sn_watcher_call_register_host_finish (
    SnWatcher *proxy,
    GAsyncResult *res,
    GError **error);

gboolean sn_watcher_call_register_host_sync (
    SnWatcher *proxy,
    const gchar *arg_service,
    GCancellable *cancellable,
    GError **error);
...
const gchar *const *sn_watcher_get_registered_items (SnWatcher *object);
gchar **sn_watcher_dup_registered_items (SnWatcher *object);
void sn_watcher_set_registered_items (SnWatcher *object, const gchar *const *value);

gboolean sn_watcher_get_is_host_registered (SnWatcher *object);
void sn_watcher_set_is_host_registered (SnWatcher *object, gboolean value);
...
#endif /* __DBUS_STATUS_NOTIFIER_WATCHER_H__ */
